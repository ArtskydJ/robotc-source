...
void autonomous()
{
	...
	//	/* RED HANGING */
	//	while (!chassisGoByTicks(150, 150)) delay(15);
	//	intakeSet(in);
	//	while (!chassisGoByTicks(100, 100)) delay(15);
	//	delay(150);

	//	while (!chassisGoByTicks(675, 675)) delay(15);
	//	while (!chassisGoByTicks(600, 600)) delay(15);
	//	while (!chassisGoByGyro(-90, gyro)) delay(15);
	//	chassisSetMecanum((-PI / 3), 127, 0);
	//	delay(750);
	//	while (!chassisGoToLine(aLINE_CENT, 60)) delay(15);
	//	while (!chassisGoToLine(aLINE_CENT, -40)) delay(15);
	//	while (!chassisGoByGyro(-195, gyro)) delay(15);
	//	chassisResetIME();
	//	while (!chassisGoByTicks(100, 100)) {
	//		liftGoToHeight(rollover); delay(15);
	//	}
	//	intakeSet(out); delay(2000);
	//	while (!chassisGoByTicks(0, 0)) {
	//		liftGoToHeight(rollover); delay(15);
	//	}
	//	intakeSet(0);
	//	chassisSetMecanum((-PI / 2), 127, 0); delay(1500);
	//	chassisResetIME();
	//	while (!chassisGoByTicks(100, 100)) {
	//		liftGoToHeight(rollover); delay(15);
	//	}
